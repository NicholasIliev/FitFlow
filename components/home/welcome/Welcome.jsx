...
import { View, Text, TextInput, TouchableOpacity, Image, FlatList, Dimensions, StatusBar, SafeAreaView, SectionList, ListItem, ScrollView } from 'react-native';
...
const Welcome = () => {
  ...
  return (
    <ScrollView contentContainerStyle={ styles.scrollViewContentContainer } showsVerticalScrollIndicator={true}>
      <View>
